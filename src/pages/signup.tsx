...
const SignUpPage: NextPage = () => {
  ...
  async function handleSignUp({ email, password }: ISignUp) {
    setIsLoading(true);
  ...
  return (
    <>
      <Head>
        <title>Sign up · Cluster App</title>
      ...
      <main className="relative flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-gray-800">
        <header className="absolute top-0 right-0 p-4">
          <Link href="/login">
            <button
              type="button"
              className="relative inline-flex w-full cursor-not-allowed items-center justify-center rounded-lg border-[1px] border-gray-300/10 bg-gray-800 px-5 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
        ...
        <section className="mx-auto w-full max-w-[450px]">
          <h1 className="text-slate-12 mt-8 mb-1.5 text-xl font-bold tracking-[-0.16px] text-gray-300">
            Sign up to Cluster App
          </h1>
          <button
            type="button"
            className="relative mt-8 inline-flex w-full items-center justify-center rounded-lg border-[1px] border-gray-300/10 bg-gray-800 px-5 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 disabled:cursor-not-allowed disabled:brightness-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            onClick={signInWithGitHub}
            disabled={isLoading}
          >
            <div
